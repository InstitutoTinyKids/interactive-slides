                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div style={{ display: 'flex', gap: '8px', marginTop: 'auto', height: '52px' }}>
                                                    ...
                                                    <button onClick={() => handleEditFolder(f)} className="btn-outline" style={{ width: '52px', height: '100%', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Editar Nombre"><Edit2 size={26} strokeWidth={2.5} /></button>
                                                    <button onClick={() => handleDuplicateFolder(f)} className="btn-outline" style={{ width: '52px', height: '100%', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Duplicar"><Copy size={26} strokeWidth={2.5} /></button>
                                                    <button onClick={() => handleDeleteFolder(f.id)} className="btn-outline" style={{ width: '52px', height: '100%', color: '#ef4444', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Eliminar"><Trash2 size={26} strokeWidth={2.5} /></button>
                                                </div>
                                                {isSortMode && (
